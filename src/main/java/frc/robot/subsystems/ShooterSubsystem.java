...
public class ShooterSubsystem extends SubsystemBase{
    ...
    public void setIncreasePR(){ShooterConstants.pr+=0.00001; shooterPidR.setP(ShooterConstants.pr);}
    public void setDecreasePR(){ShooterConstants.pr-=0.00001; shooterPidR.setP(ShooterConstants.pr);}
    public void setIncreaseDR(){ShooterConstants.dr+=0.000001; shooterPidR.setD(ShooterConstants.dr);}
    public void setDecreaseDR(){ShooterConstants.dr-=0.000001; shooterPidR.setD(ShooterConstants.dr);}

    public void setIncreaseFRHigh(){ShooterConstants.frHigh+=0.000001; if (ShooterConstants.shootSpeed==ShooterConstants.shootSpeedConst) ShooterConstants.fr=ShooterConstants.frHigh;}
    public void setDecreaseFRHigh(){ShooterConstants.frHigh-=0.000001; if (ShooterConstants.shootSpeed==ShooterConstants.shootSpeedConst) ShooterConstants.fr=ShooterConstants.frHigh;}
    public void setIncreaseFRLow(){ShooterConstants.frLow+=0.000001; if (ShooterConstants.shootSpeed==ShooterConstants.shootSpeedConstLow) ShooterConstants.fr=ShooterConstants.frLow;}
    public void setDecreaseFRLow(){ShooterConstants.frLow-=0.000001; if (ShooterConstants.shootSpeed==ShooterConstants.shootSpeedConstLow) ShooterConstants.fr=ShooterConstants.frLow;}
